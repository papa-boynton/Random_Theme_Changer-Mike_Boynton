...
<div style="display:inline-block;" class="vertical-center" style="margin: 0; position: absolute; top: 50%; -ms-transform: translateY(-50%); transform: translateY(-50%);"><pre><h1 style="font-size: 120px;">Random Theme Changer</h1></pre></span>
</div>
<pre>
...
Also has a popup that is displayed with a preview of the new theme when changed.
</pre>
</body>
